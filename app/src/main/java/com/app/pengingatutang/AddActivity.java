...
public class AddActivity extends AppCompatActivity implements com.wdullaer.materialdatetimepicker.date.DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tanggaljatuh = findViewById(R.id.edit_tanggaljatuh);
    ...
    public void insertPeminjaman(){
        ...
        peminjaman.setDateDue(tanggaljatuh.getText().toString().trim());
        ...
        if (TextUtils.isEmpty(editTextName.getText().toString().trim())||
                ...
                TextUtils.isEmpty(tanggaljatuh.getText().toString().trim())||
    ...
    public void onDateSet(com.wdullaer.materialdatetimepicker.date.DatePickerDialog view, int year, int monthOfYear, int dayOfMonth) {
        ...
        tanggaljatuh.setText(currentDateString);
