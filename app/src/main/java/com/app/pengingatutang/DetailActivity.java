...
import com.app.pengingatutang.adapter.PembayaranListAdapter;
import com.app.pengingatutang.database.DBHelper;
import com.app.pengingatutang.entities.Pembayaran;
import com.app.pengingatutang.entities.Peminjaman;
import com.app.pengingatutang.function.FunctionPembayaran;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        Button btnPembayaran2 = findViewById(R.id.pembayaran);
        if (mPayment == peminjaman.getAmount()){
    ...
    public void call(){
        ...
        String Nama = peminjaman.getName();
        String Tanggal = peminjaman.getDateDue();
        Integer Jumlah = peminjaman.getAmount();

        startActivity(
                new Intent(Intent.ACTION_VIEW,
                        Uri.parse(
                                String.format("https://api.whatsapp.com/send?phone=+62" + phoneNumber + "&text=" + "Hallo " + Nama + " Jangan Lupa Bayar Pinjaman Sebesar " + Jumlah + " Pada Tanggal " + Tanggal)
                        )
                )
        );
    }
